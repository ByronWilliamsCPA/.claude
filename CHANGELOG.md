...
* Add CI Gate, Security Gate Validation, and Dependency & Standards Validation gate jobs to .github/workflows/ (ci.yml, security-analysis.yml, pr-validation.yml); satisfies CI-014, CI-015, CI-016 blocking check contexts required by branch protection

* Add CI-014 through CI-017 to standards-manifest.yaml; update ossf-compliance-auditor to audit CI-017 at audit time; fix setup_github_protection.py to register short job display names instead of the stale Workflow / Job composite format
