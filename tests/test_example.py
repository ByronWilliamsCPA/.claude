"""Example tests demonstrating best practices for Claude Code Configuration.
...
class TestCLI:
    ...
    def test_cli_config_command(self) -> None:
        ...
        assert "Project: Claude Code Configuration" in result.output
    ...
    def test_cli_context_setup(self) -> None:
        ...
        assert result.exit_code == 0
        assert "Claude Code Configuration" in result.output
    ...
    def test_cli_hello_error_handling(self) -> None:
        ...
        with patch("claude_config.cli.logger") as mock_logger:
