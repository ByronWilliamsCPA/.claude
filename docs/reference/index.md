...
- [Renovate Architecture](renovate-architecture.md): self-hosted Renovate stack, layered config inheritance, manifest enforcement (TOOL-013, PC-016, CI-020, CI-021, CI-059, CI-061), and relationship to Dependabot, SBOM, and pip-audit.
