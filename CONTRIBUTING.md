...
Thank you for your interest in contributing to Claude Code Configuration! This document provides guidelines and instructions for contributing to the project.
...
import pytest
from pathlib import Path
from claude_config.core import YourModule
...
- **General Questions**: Open a [GitHub Discussion](https://github.com/ByronWilliamsCPA/.claude/discussions)
- **Bug Reports**: Open a [GitHub Issue](https://github.com/ByronWilliamsCPA/.claude/issues)
