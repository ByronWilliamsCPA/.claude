...
need. This extract-and-own approach is the disposition recorded in
`docs/tool-evals/skills-deep-dive-2026-06.md` (item 19) and
`docs/tool-evals/skills-repos-survey-2026-06.md`.
...
| `typography.csv` | 73 | Curated font pairings: heading + body font, mood keywords, best-for, Google Fonts URL, CSS import, Tailwind config | Picking a font pairing with ready-to-paste imports |
...
| `app-interface.csv` | 29 | Interface correctness issues with Do / Don't and good/bad code examples, tagged by platform and severity | Reviewing or building interface details (accessible labels, touch targets, focus states) |
